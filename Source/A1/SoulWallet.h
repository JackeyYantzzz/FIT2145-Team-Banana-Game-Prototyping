...
UCLASS(ClassGroup = (Custom), meta = (BlueprintSpawnableComponent)) class A1_API USoulWallet : public UActorComponent
{
	GENERATED_BODY() 
public: 
	USoulWallet(); 
...
public: 
	...
	int32 GetSoul() const; UFUNCTION(BlueprintCallable, Category = "Soul") 
